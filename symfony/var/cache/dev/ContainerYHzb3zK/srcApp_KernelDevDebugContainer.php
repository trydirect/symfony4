...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rGKeJEt+DP', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CnDufUijht', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($a, ['paths' => [($this->targetDirs[3].'/vendor/knplabs/knp-menu/src/Knp/Menu/Resources/views') => NULL], 'default_path' => ($this->targetDirs[3].'/templates'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => [0 => 'form_div_layout.html.twig'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MzCMmCyN4U', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VqYkQRsnpe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cx7HEW9Qd4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y8+0gw5Q8g', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'sonata.core.form.types' => [
                0 => 'form.type.form',
                1 => 'form.type.choice',
                2 => 'sonata.core.form.type.array_legacy',
                3 => 'sonata.core.form.type.boolean_legacy',
                4 => 'sonata.core.form.type.collection_legacy',
                5 => 'sonata.core.form.type.translatable_choice',
                6 => 'sonata.core.form.type.date_range_legacy',
                7 => 'sonata.core.form.type.datetime_range_legacy',
                8 => 'sonata.core.form.type.date_picker_legacy',
                9 => 'sonata.core.form.type.datetime_picker_legacy',
                10 => 'sonata.core.form.type.date_range_picker_legacy',
                11 => 'sonata.core.form.type.datetime_range_picker_legacy',
                12 => 'sonata.core.form.type.equal_legacy',
                13 => 'sonata.core.form.type.color_selector',
                14 => 'sonata.core.form.type.color_legacy',
                15 => 'sonata.core.form.type.array',
                16 => 'sonata.core.form.type.boolean',
                17 => 'sonata.core.form.type.collection',
                18 => 'sonata.core.form.type.date_range',
                19 => 'sonata.core.form.type.datetime_range',
                20 => 'sonata.core.form.type.date_picker',
                21 => 'sonata.core.form.type.datetime_picker',
                22 => 'sonata.core.form.type.date_range_picker',
                23 => 'sonata.core.form.type.datetime_range_picker',
                24 => 'sonata.core.form.type.equal',
                25 => 'sonata.block.form.type.block',
                26 => 'sonata.block.form.type.container_template',
                27 => 'sonata.admin.form.type.admin',
                28 => 'sonata.admin.form.type.model_choice',
                29 => 'sonata.admin.form.type.model_list',
                30 => 'sonata.admin.form.type.model_reference',
                31 => 'sonata.admin.form.type.model_hidden',
                32 => 'sonata.admin.form.type.model_autocomplete',
                33 => 'sonata.admin.form.type.collection',
                34 => 'sonata.admin.doctrine_orm.form.type.choice_field_mask',
                35 => 'sonata.admin.form.filter.type.number',
                36 => 'sonata.admin.form.filter.type.choice',
                37 => 'sonata.admin.form.filter.type.default',
                38 => 'sonata.admin.form.filter.type.date',
                39 => 'sonata.admin.form.filter.type.daterange',
                40 => 'sonata.admin.form.filter.type.datetime',
                41 => 'sonata.admin.form.filter.type.datetime_range',
                42 => 'liip_imagine.form.type.image',
            ],
            ...
            'console.command.ids' => [
                ...
                2 => 'console.command.public_alias.Sonata\\BlockBundle\\Command\\DebugBlocksCommand',
                3 => 'Sonata\\AdminBundle\\Command\\CreateClassCacheCommand',
                4 => 'Sonata\\AdminBundle\\Command\\ExplainAdminCommand',
                5 => 'Sonata\\AdminBundle\\Command\\GenerateAdminCommand',
                6 => 'Sonata\\AdminBundle\\Command\\GenerateObjectAclCommand',
                7 => 'Sonata\\AdminBundle\\Command\\ListAdminCommand',
                8 => 'Sonata\\AdminBundle\\Command\\SetupAclCommand',
            ],
        ];
    }
}
